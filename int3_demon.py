...
st.markdown("My 1st interview demo, visit [here](https://lamachinelearningdemo.streamlit.app/). For a detailed comparison, visit [here](https://cmdcomparison.streamlit.app/)")
